...
if [ $number -gt 0 ]
    then
        ...
        curl -H "access_token : Zs0nTQB-ujOSV0KmEoPhBx2E6-Ab_GKO" -H "Content-Type : application/json" --data "{ \"data\" : [{ \"process\" : \"$number\" }]}" http://api.masterdatanode.com/demo/macprocess/save/
fi
